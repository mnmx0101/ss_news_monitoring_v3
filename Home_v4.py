"""
News Analytics Platform - Home Page (V4)
...
def home_page():
    ...
    st.title("South Sudan News Analytics Platform (V4)")

    st.markdown("""
Welcome to the **South Sudan News Analytics Platform (V4)**—a specialized decision-support tool designed for humanitarian and food security analysts. This platform provides real-time monitoring and historical analysis of news trends across South Sudan, utilizing data synthesized from [Radio Tamazuj](https://www.radiotamazuj.org/en/about-us).
...
**5. Minimum history warning** — The platform flags any county with fewer than *N* months of history (default: **12 months**, adjustable in the sidebar) as using nationally-scaled fallback thresholds. The counties listed above are most likely to trigger this warning.
...
national   = st.Page("pages_v4/4_National_Overview.py", title="National Overview",   icon="🌍")
adm1       = st.Page("pages_v4/2_ADM1_Insights.py",     title="ADM1 Insights",       icon="🗺️")
adm2       = st.Page("pages_v4/3_ADM2_Insights.py",     title="ADM2 Insights",       icon="📍")
validation = st.Page("pages_v4/5_Validation_Reference.py", title="Validation Reference", icon="✅")
...
st.set_page_config(
    page_title="News Analytics Platform (V4)",
    page_icon="📰",
    layout="wide"
)
